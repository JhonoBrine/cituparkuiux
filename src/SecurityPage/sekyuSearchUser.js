...
const SearchUser = () => {
  ...
  const handleSearchUser = () => {
    navigate('/sekyuNav/SearchResult');
  };
          ...
          <Box className="customBox" style={{marginLeft: '5%', marginTop: '50px',outline: '5px solid #f6c301'}}>
            <div className='TextField'>
              ...
              <div className='test'>
                ...
                >
                  <List className='Usertype-popup' style={{backgroundColor: 'gold', color: 'maroon', width: '800px'}}>
                    {['STUDENT', 'EMPLOYEE', 'SECURITY GUARD'].map((type) => (
