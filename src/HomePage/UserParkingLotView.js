...
const fetchParkingSlotData = () => {
	...
	const updateParkingLotData = (id) => {
		...
		const parkingLotView_btn = (id) => {
			switch(id){
				case 1:
					return <Link to="/parkingLotView/rtl"><button>VIEW</button></Link>
				case 2:
					return <Link to="/parkingLotView/nge"><button>VIEW</button></Link>
				case 3:
					return <Link to="/parkingLotView/gle"><button>VIEW</button></Link>
				case 4:
					return <Link to="/parkingLotView/backgate"><button>VIEW</button></Link>
				case 5:
					return <Link to="/parkingLotView/library"><button>VIEW</button></Link>
				default:
					return null;
			}
